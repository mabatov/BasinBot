...
def start_message(message):
    ...
    print("The result of db_check_user: " + str(regState))
    if regState is not None:
        print('Пользователь ' + str(regState) + ' уже зарегистрирован.')
        ...
        print('Пользователь ' + str(username) + ' успешно зарегистрирован.')
...
def get_text_messages(message):
    ...
    if message.text == "Заступил на дежурство!":
        if db_checkBooking() is not None:
            ...
            print(username + ' пытался захватить тазик.')
            ...
            print(username + ' приступил к стирке.')
        ...
        if db_checkBooking() is not None and (str(db_checkBooking())[2:-3] != username):
            ...
            db_stopBooking(user_id=user_id, username=username, user_firstname=user_firstname,
                           user_lastname=user_lastname)
            print('@' + str(username) + ' освободил тазик.')
